...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(tr("&About Nanocoin"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/nanocoin"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/nanocoin_testnet"));
            setWindowIcon(QIcon(":icons/nanocoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/nanocoin_testnet"));
#endif
            if(trayIcon)
            {
